...
def modified_googlenet(WIDTH, HEIGHT):
    ...
    loss1_classifier = Dense(1, name='loss1/classifier', W_regularizer=l2(0.0002))(loss1_drop_fc)
    ...
    loss2_classifier = Dense(1, name='loss2/classifier', W_regularizer=l2(0.0002))(loss2_drop_fc)
